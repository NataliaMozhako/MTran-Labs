    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.OutputEncoding = System.Text.Encoding.UTF8;
                             // D:\Education\Laboratory_works\МТран\Lab5\ConsoleApp1
            string FILENAME = @"D:/Education/Laboratory_works/МТран/Lab5/ConsoleApp1//test.py";
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine($"INTERPRETATION ERROR {e.ErrorType}");
                Console.ResetColor();
                Console.WriteLine($"line {e.LineNumber} char {e.PositionInLine}:");
